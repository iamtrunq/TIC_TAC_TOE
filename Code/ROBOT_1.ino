...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void backhome(double t1,double t2)      // Hàm trở về HOME
{ 
      if (t1>=0){digitalWrite(dirPInX,LOW);}
      else {digitalWrite(dirPInX,HIGH);}
      if (t2>=0){digitalWrite(dirPInY,LOW);}
      else {digitalWrite(dirPInY,HIGH);}
      
      digitalWrite(dirPInY,LOW);
       
      while(digitalRead(CT1)==1)
      {
      ...
      delay(1);
       ...
       // tùy theo giá trị t1,t2 tính được là âm hay dương để quy định chiều quay của động cơ  
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//        Serial.println(R);
  ...
  for (double t = 0 ; t <= 2*PI + 1; t = t + 0.05)
  {   
